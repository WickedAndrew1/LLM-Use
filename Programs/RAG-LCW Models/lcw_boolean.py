...
def generate_response(query, max_length=512):
    ...
    prompt = f"""<|system|>
    You are a helpful assistant who specializes in US Federal Acquisition Regulation (FAR). Answer the user's question with a "true" or "false" to the best of your ability based on your knowledge of FAR.
    </|system|>
...
RESULTS_FILE = "lcwbool3.json"
METRICS_FILE = "lcwbool3_performance.json"
